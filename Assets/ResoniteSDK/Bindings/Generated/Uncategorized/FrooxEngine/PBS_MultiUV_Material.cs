...
members.Add("SecondaryAlbedoTexture", SecondaryAlbedoTexture.ToResoniteReference(context));
members.Add("SecondaryEmissiveColor", SecondaryEmissiveColor.ToResoniteLinkField());
members.Add("SecondaryEmissiveMap", SecondaryEmissiveMap.ToResoniteReference(context));
