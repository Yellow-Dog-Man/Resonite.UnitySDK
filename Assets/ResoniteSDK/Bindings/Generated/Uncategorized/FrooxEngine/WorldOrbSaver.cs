...
members.Add("Orb", new ResoniteLink.Reference() { });
members.Add("saveHereItem", new ResoniteLink.Reference() { });
members.Add("saveToInventoryItem", new ResoniteLink.Reference() { });
members.Add("cancelItem", new ResoniteLink.Reference() { });
members.Add("menu", new ResoniteLink.Reference() { });
