...
members.Add("_worldOrb", new ResoniteLink.Reference() { });
members.Add("_name", new ResoniteLink.Reference() { });
members.Add("_description", new ResoniteLink.Reference() { });
members.Add("_path", new ResoniteLink.Reference() { });
members.Add("_tags", new ResoniteLink.Reference() { });
members.Add("_publicSetting", _publicSetting.ToResoniteLinkField());
members.Add("_readonly", new ResoniteLink.Reference() { });
members.Add("_ownerUser", new ResoniteLink.SyncObject() { Members = _ownerUser.CollectMembers() });
members.Add("_privateOptionText", new ResoniteLink.Reference() { });
}
