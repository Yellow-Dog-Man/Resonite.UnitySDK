...
members.Add("_editor", new ResoniteLink.Reference() { });
members.Add("_editIconPosition", new ResoniteLink.Reference() { });
members.Add("_editIconScale", new ResoniteLink.Reference() { });
}
