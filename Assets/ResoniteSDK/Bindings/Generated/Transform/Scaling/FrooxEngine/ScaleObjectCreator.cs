...
members.Add("TemplateNameField", new ResoniteLink.Reference() { });
members.Add("TemplateSizeField", new ResoniteLink.Reference() { });
members.Add("_sizeParser", new ResoniteLink.Reference() { });
