...
members.Add("H", new ResoniteLink.Reference() { });
members.Add("S", new ResoniteLink.Reference() { });
members.Add("L", new ResoniteLink.Reference() { });
members.Add("TargetProfile", new ResoniteLink.Reference() { });
}
