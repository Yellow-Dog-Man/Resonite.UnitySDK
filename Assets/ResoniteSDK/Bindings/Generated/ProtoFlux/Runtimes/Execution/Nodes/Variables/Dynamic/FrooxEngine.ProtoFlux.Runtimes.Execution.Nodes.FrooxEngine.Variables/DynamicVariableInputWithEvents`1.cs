...
members.Add("DetectingUser", new ResoniteLink.Reference() { });
members.Add("OnSpaceLinked", new ResoniteLink.Reference() { });
members.Add("OnSpaceUnlinked", new ResoniteLink.Reference() { });
}
