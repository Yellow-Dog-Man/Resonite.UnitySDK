...
members.Add("_leftFootstep", new ResoniteLink.SyncObject() { Members = _leftFootstep.CollectMembers() });
members.Add("_rightFootstep", new ResoniteLink.SyncObject() { Members = _rightFootstep.CollectMembers() });
}
