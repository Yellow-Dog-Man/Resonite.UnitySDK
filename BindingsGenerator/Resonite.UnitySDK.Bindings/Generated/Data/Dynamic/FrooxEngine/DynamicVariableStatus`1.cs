...
members.Add("IsLinkedToSpace", IsLinkedToSpace_Element.Data.ToResoniteLinkField());
members.Add("VariableExists", VariableExists_Element.Data.ToResoniteLinkField());
}
