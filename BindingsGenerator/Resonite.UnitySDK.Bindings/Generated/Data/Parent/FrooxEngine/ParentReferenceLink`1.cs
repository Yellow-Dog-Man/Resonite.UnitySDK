...
public Field<global::FrooxEngine.SyncRef<T>, T> DefaultReference_Element = new();
...
members.Add("DefaultReference", DefaultReference_Element.Data.ToResoniteReference(context));
}
