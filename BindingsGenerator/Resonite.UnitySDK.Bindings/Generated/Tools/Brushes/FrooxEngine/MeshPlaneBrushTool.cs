...
members.Add("_currentMesh", _currentMesh_Element.Data.ToResoniteReference(context));
members.Add("_currentHole", _currentHole_Element.Data.ToResoniteReference(context));
}
