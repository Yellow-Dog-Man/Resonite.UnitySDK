...
members.Add("EnsureSingleInstance", EnsureSingleInstance_Element.Data.ToResoniteLinkField());
members.Add("AllowPickup", AllowPickup_Element.Data.ToResoniteLinkField());
members.Add("_label", _label_Element.Data.ToResoniteReference(context));
members.Add("_templateRoot", _templateRoot_Element.Data.ToResoniteReference(context));
}
