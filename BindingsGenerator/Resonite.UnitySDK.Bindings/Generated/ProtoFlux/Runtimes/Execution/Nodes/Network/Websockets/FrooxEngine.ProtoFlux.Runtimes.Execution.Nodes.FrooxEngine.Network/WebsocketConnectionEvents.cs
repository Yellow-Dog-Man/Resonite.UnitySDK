...
members.Add("OnConnected", OnConnected_Element.Data.ToResoniteReference(context));
members.Add("OnDisconnected", OnDisconnected_Element.Data.ToResoniteReference(context));
}
