...
public Field<global::FrooxEngine.RelayRef<global::FrooxEngine.BoxCollider>, global::FrooxEngine.BoxCollider> _target_Element = new();
...
members.Add("_cubeGizmo", _cubeGizmo_Element.Data.ToResoniteReference(context));
}
