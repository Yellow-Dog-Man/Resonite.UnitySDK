...
members.Add("_worker", _worker_Element.Data.ToResoniteReference(context));
members.Add("_gizmo", _gizmo_Element.Data.ToResoniteReference(context));
members.Add("_type", _type_Element.Data.ToResoniteLinkField());
}
