...
members.Add("UseRandomDistribution", UseRandomDistribution_Element.Data.ToResoniteLinkField());
members.Add("Distribution", Distribution_Element.Data.ToResoniteReference(context));
}
