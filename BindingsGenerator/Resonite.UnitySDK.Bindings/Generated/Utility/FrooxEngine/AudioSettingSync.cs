...
members.Add("DefaultAudioInputDeviceIndex", DefaultAudioInputDeviceIndex_Element.Data.ToResoniteLinkField());
members.Add("DefaultAudioOutputDeviceIndex", DefaultAudioOutputDeviceIndex_Element.Data.ToResoniteLinkField());
members.Add("MasterVolume", MasterVolume_Element.Data.ToResoniteLinkField());
members.Add("WhisperVoiceVolume", WhisperVoiceVolume_Element.Data.ToResoniteLinkField());
members.Add("NoiseGateThreshold", NoiseGateThreshold_Element.Data.ToResoniteLinkField());
members.Add("NoiseGateAttack", NoiseGateAttack_Element.Data.ToResoniteLinkField());
members.Add("NoiseGateHold", NoiseGateHold_Element.Data.ToResoniteLinkField());
members.Add("NoiseGateRelease", NoiseGateRelease_Element.Data.ToResoniteLinkField());
members.Add("NormalizationThreshold", NormalizationThreshold_Element.Data.ToResoniteLinkField());
members.Add("VoiceNormalization", VoiceNormalization_Element.Data.ToResoniteLinkField());
members.Add("NoiseSupression", NoiseSupression_Element.Data.ToResoniteLinkField());
}
