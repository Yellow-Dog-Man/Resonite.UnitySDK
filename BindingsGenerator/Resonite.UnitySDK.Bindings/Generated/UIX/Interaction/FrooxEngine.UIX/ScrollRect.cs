...
members.Add("NormalizedPosition", NormalizedPosition_Element.Data.ToResoniteLinkField());
...
members.Add("ViewportOverride", ViewportOverride_Element.Data.ToResoniteReference(context));
members.Add("__legacyContent", __legacyContent_Element.Data.ToResoniteReference(context));
}
