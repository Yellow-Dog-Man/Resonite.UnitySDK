...
members.Add("TargetCanvas", TargetCanvas_Element.Data.ToResoniteReference(context));
members.Add("_renderOffset", _renderOffset_Element.Data.ToResoniteReference(context));
members.Add("_maskDepth", _maskDepth_Element.Data.ToResoniteReference(context));
}
