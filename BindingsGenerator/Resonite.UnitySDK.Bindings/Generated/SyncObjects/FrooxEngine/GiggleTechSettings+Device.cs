...
members.Add("IP", IP_Element.Data.ToResoniteLinkField());
members.Add("IsConnected", IsConnected_Element.Data.ToResoniteLinkField());
members.Add("UseDevice", UseDevice_Element.Data.ToResoniteLinkField());
members.Add("AlwaysTreatAsConnected", AlwaysTreatAsConnected_Element.Data.ToResoniteLinkField());
members.Add("CustomName", CustomName_Element.Data.ToResoniteLinkField());
members.Add("IntensityScale", IntensityScale_Element.Data.ToResoniteLinkField());
members.Add("MinimumIntensity", MinimumIntensity_Element.Data.ToResoniteLinkField());
members.Add("InitialActivationIntensity", InitialActivationIntensity_Element.Data.ToResoniteLinkField());
members.Add("HapticPointMapping", new ResoniteLink.SyncObject() { Members = HapticPointMapping.CollectMembers(context) });
members.Add("HapticPointIndex", HapticPointIndex_Element.Data.ToResoniteLinkField());
}
