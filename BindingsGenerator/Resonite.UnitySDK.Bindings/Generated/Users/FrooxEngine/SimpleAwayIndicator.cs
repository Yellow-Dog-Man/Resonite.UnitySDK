...
members.Add("AwayMaterial", AwayMaterial_Element.Data.ToResoniteReference(context));
...
{
    Elements = _oldMaterials.Data.ConvertList(m => m.Data.ToResoniteReference(context))
});
}
