...
members.Add("HandSide", HandSide_Element.Data.ToResoniteLinkField());
members.Add("_rootPos", _rootPos_Element.Data.ToResoniteLinkField());
members.Add("TipReference", TipReference_Element.Data.ToResoniteReference(context));
members.Add("ShowVisual", ShowVisual_Element.Data.ToResoniteLinkField());
members.Add("DisableSlider", DisableSlider_Element.Data.ToResoniteLinkField());
members.Add("_activeVisual", _activeVisual_Element.Data.ToResoniteReference(context));
}
